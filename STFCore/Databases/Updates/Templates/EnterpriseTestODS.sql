...
/*===========================================================================*/
-- IF YOU ARE UPDATING ENTERPRISETESTODS TABLES
-- Not all systems may have the EnterpriseTestODS table that is being updated.
-- So, if you are altering the database schema then please wrap the SQL
-- commands with the appropriate check below.  This will help to ensure that an
-- error does not occur when the SQL script is ran.
--

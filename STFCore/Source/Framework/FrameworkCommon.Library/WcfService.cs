...
namespace HP.ScalableTest.Framework
{
    ...
    public static class WcfServiceHelper
    {
        ...
        {
            return new Uri("http://{0}:{1}/{2}".FormatWith(hostName, port, service));
        }
        ...
        {
            return new Uri("http://{0}:{1}/{2}-{3}".FormatWith(hostName, port, service, extension));
        }
        ...
        {
            return new Uri("http://localhost:{0}/{1}".FormatWith((int)service, service));
        }
        ...
        {
            return new Uri("http://localhost:{0}/{1}-{2}".FormatWith((int)service, service, extension));
        }
        ...
        {
            return new Uri("net.pipe://localhost/{0}".FormatWith(service));
        }
        ...
        {
            return new Uri("net.pipe://{0}/{1}".FormatWith(hostName, service));
        }
        ...
        {
            return new Uri("net.pipe://localhost/{0}-{1}".FormatWith(service, extension));
        }
    }
}

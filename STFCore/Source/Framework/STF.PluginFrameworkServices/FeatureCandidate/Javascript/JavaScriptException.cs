...
namespace HP.DeviceAutomation.FeatureCandidate.Javascript
{
    ...
    public class JavaScriptException : Exception
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JavaScriptException" /> class with a specified error message.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JavaScriptException" /> class with a specified error message and a reference to the inner exception that is the cause of this exception.
        /// </summary>

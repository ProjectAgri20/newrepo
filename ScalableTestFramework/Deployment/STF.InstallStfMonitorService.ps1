<#
.SYNOPSIS
Installs the STF Monitor Service on this machine.
...
Update-StfService STFMonitorService $sourceServer $sourceSharePath $destinationPath
Start-ServiceWithArgs STFMonitorService "/database=$databaseServer"

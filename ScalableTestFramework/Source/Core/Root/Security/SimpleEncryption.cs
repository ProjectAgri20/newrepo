...
namespace HP.ScalableTest.Core.Security
{
    ...
    public static class SimpleEncryption
    {
        ...
        /// <summary>
        /// Encrypts the specified clear text using the specified encryption key.
        /// </summary>
        ...
        public static string Encrypt(string clearText, string key)
        {
            ...
            byte[] encryptedData = CryptoTransform(clearBytes, key, n => n.CreateEncryptor());
        ...
        /// <summary>
        /// Decrypts the specified cipher text using the specified encryption key.
        /// </summary>
        ...
        public static string Decrypt(string cipherText, string key)
        {
            ...
            byte[] decryptedData = CryptoTransform(cipherBytes, key, n => n.CreateDecryptor());
        ...
        private static byte[] CryptoTransform(byte[] data, string key, Func<SymmetricAlgorithm, ICryptoTransform> createTransform)
        {
            using (Rijndael rijndael = Rijndael.Create())
            {
                // Create the key and initialization vector using the password.
                using (PasswordDeriveBytes pdb = new PasswordDeriveBytes(key, _salt))
                {

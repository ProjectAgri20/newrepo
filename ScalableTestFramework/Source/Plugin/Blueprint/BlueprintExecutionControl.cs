...
{
    [ToolboxItem(false)]
    public partial class BlueprintExecutionControl : UserControl, IPluginExecutionEngine
    {
        private StringBuilder _logText = new StringBuilder();
        DocumentCollectionIterator _documentCollectionIterator = null;

        /// <summary>
        /// Initializes a new instance of the <see cref="BlueprintExecutionControl" /> class.
        /// </summary>
        public BlueprintExecutionControl()
        {
            InitializeComponent();
        }

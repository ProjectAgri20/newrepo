...
namespace HP.ScalableTest.Plugin.DSSConfiguration.UIMaps
{
    ...
    /// </summary>
    public class DeviceFolderWorkflow
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceFolderWorkflow"/> class.
        /// </summary>
        /// <param name="framework">
        /// The framework.
        /// </param>                      
        public DeviceFolderWorkflow(UIAFramework framework)
        {
            Desktop = new Desktop(framework);
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="DeviceFolderWorkflow"/> class using the default UIAFramework.
        /// </summary>
        public DeviceFolderWorkflow()
        {
            Desktop = new Desktop();
        }
        ...
        /// The IP address.
        /// </param>
        public DeviceFolderWorkflow(string _ipAddress)
        {
        ...
        public Text TextBlockDup0Text
        {
            get
            {
                ...
                {
                    fTextBlockDup0Text = new Text("TextBlockDup0Text", TextAA63352F914Text);
        ...
        public Text TextBlockDup1Text
        {
            get
            {
                ...
                {
                    fTextBlockDup1Text = new Text("TextBlockDup1Text", TextB31E1B768A7Text);
        ...
        public Custom TabStatusUserCoCustom
        {
            get
            {
                ...
                {
                    fTabStatusUserCoCustom = new Custom("TabStatusUserCoCustom", SystemWindowsCoDup5TabItem);
        ...
        public Custom MfpEnhancedWorkCustom
        {
            get
            {
                ...
                {
                    fMfpEnhancedWorkCustom = new Custom("MfpEnhancedWorkCustom", SystemWindowsCoDup5TabItem);
...
2.  Position is required.");
        ...
        public ListItem COMMONMFPGROUPLDup1ListItem
        {
            get
            {
                ...
                {
                    fCOMMONMFPGROUPLDup1ListItem = new ListItem("COMMONMFPGROUPLDup1ListItem", ComboBoxA9893D6ComboBox);
        ...
        public ListItem AbcListBoxItemDup1ListItem
        {
            get
            {
                ...
                {
                    fAbcListBoxItemDup1ListItem = new ListItem("AbcListBoxItemDup1ListItem", ComboBoxA9893D6ComboBox);
        ...
        /// Gets Reference to desktop
        /// </summary>
        public Edit TextBox01092B21Dup0I0XEdit
        {
            get
            {
        ...
        public Pane ScrollViewerPARDup0Pane
        {
            get
            {
                ...
                {
                    fScrollViewerPARDup0Pane = new Pane("ScrollViewerPARDup0Pane", TextBox01092B21Dup0I0XEdit);
        ...
        /// Gets Reference to desktop
        /// </summary>
        public Edit TextBox01092B21Dup1I1XEdit
        {
            get
            {
        ...
        public Pane ScrollViewerPARDup1Pane
        {
            get
            {
                ...
                {
                    fScrollViewerPARDup1Pane = new Pane("ScrollViewerPARDup1Pane", TextBox01092B21Dup1I1XEdit);
        ...
        public Text TextBlockDup3Text
        {
            get
            {
                ...
                {
                    fTextBlockDup3Text = new Text("TextBlockDup3Text", Text22D9C34E84CText);
        ...
        public DataItem bound101114135eDataItem
        {
            get
            {
                if (null == fbound101114135eDataItem)
                {
                    ...
                    fbound101114135eDataItem.UIMap.SearchProperties.Add(UIASearchProperty.Name, $@"bound; {_deviceIP}; email=disabled; folder=disabled; fax=disabled; addressing=disabled; authentication=notApplicable; customKey=disabled; sharePoint=notApplicable; {_deviceModelName}; {_deviceIP}; {_deviceModelName}");
                }
        ...
        public Text HPLaserJetMFPM5Dup1I1XText
        {
            get
            {
                if (null == fHPLaserJetMFPM5Dup1I1XText)
                {
                    ...
                    fHPLaserJetMFPM5Dup1I1XText.UIMap.SearchProperties.Add(UIASearchProperty.Name, $@"{_deviceModelName}");
                }
        ...
        public Text A101114135TextBText
        {
            get
            {
                if (null == fA101114135TextBText)
                {
                    ...
                    fA101114135TextBText.UIMap.SearchProperties.Add(UIASearchProperty.Name, $@"{_deviceIP}");
                }
        ...
        public Text TextBlockDup4Text
        {
            get
            {
                ...
                {
                    fTextBlockDup4Text = new Text("TextBlockDup4Text", bound101114135eDataItem);
        ...
        public Text HPLaserJetMFPM5Dup2I2XText
        {
            get
            {
                if (null == fHPLaserJetMFPM5Dup2I2XText)
                {
                    ...
                    fHPLaserJetMFPM5Dup2I2XText.UIMap.SearchProperties.Add(UIASearchProperty.Name, $@"{_deviceModelName}");
                }

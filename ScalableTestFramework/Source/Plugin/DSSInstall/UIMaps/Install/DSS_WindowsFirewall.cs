...
namespace HP.ScalableTest.Plugin.DSSInstall.UIMaps
{
    ...
    /// </summary>
    public class DSS_WindowsFirewall: UIMap
    {
        ...
        /// <summary>
        /// Backing field for DSSusesthefolloText property
        /// </summary>
        private Text fDSSusesthefolloText;

        /// <summary>
        /// Backing field for AllowDSSInstallCheckBox property
        /// </summary>
        private CheckBox fAllowDSSInstallCheckBox;
        ...
        /// <summary>
        /// Backing field for WindowsFirewallText property
        /// </summary>
        private Text fWindowsFirewallText;

        /// <summary>
        /// Backing field for WindowsFirewallImage property
        /// </summary>
        private Image fWindowsFirewallImage;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DSS_WindowsFirewall"/> class using the default UIAFramework.
        /// </summary>
        public DSS_WindowsFirewall()
        {
            Desktop = new Desktop();
            ScreenName = "Firewall Screen";
            ScreenIndex = 6;
        ...
        public DSS_WindowsFirewall(string version)
        {
        ...
        /// Gets Reference to desktop
        /// </summary>
        public Text DSSusesthefolloText
        {
            get
            {
                if (null == fDSSusesthefolloText)
                {
                    fDSSusesthefolloText = new Text("DSSusesthefolloText", HPDigitalSendinWindow);
                    fDSSusesthefolloText.UIMap.Scope = UIASeachScope.Children;
                    fDSSusesthefolloText.UIMap.SearchProperties.Add(UIASearchProperty.ClassName, @"Static");
                    fDSSusesthefolloText.UIMap.SearchProperties.Add(UIASearchProperty.AutomationId, @"8463");
                    fDSSusesthefolloText.UIMap.SearchProperties.Add(UIASearchProperty.Name, @"DSS uses the following ports: 1783, 7627, 5213, 22986. If you are using Windows Firewall, this installer can open these ports for you. If there are any other network entities (other firewalls, routers, switches) that may block the use of these ports from the DSS server you must ensure the ports are opened for DSS to function correctly. For more information on DSS’s use of ports please see the System Administration Guide.");
                }

                return fDSSusesthefolloText;
            }
        }
        ...
        /// Gets Reference to desktop
        /// </summary>
        public CheckBox AllowDSSInstallCheckBox
        {
            get
            {
                if (null == fAllowDSSInstallCheckBox)
                {
                    fAllowDSSInstallCheckBox = new CheckBox("AllowDSSInstallCheckBox", HPDigitalSendinWindow);
                    fAllowDSSInstallCheckBox.UIMap.Scope = UIASeachScope.Children;
                    fAllowDSSInstallCheckBox.UIMap.SearchProperties.Add(UIASearchProperty.ClassName, @"Button");
                    fAllowDSSInstallCheckBox.UIMap.SearchProperties.Add(UIASearchProperty.Name, @"Allow DSS Installer to open the required ports in Windows Firewall.");
                }

                return fAllowDSSInstallCheckBox;
            }
        }
        ...
        /// Gets Reference to desktop
        /// </summary>
        public Text WindowsFirewallText
        {
            get
            {
                if (null == fWindowsFirewallText)
                {
                    fWindowsFirewallText = new Text("WindowsFirewallText", HPDigitalSendinWindow);
                    fWindowsFirewallText.UIMap.Scope = UIASeachScope.Children;
                    fWindowsFirewallText.UIMap.SearchProperties.Add(UIASearchProperty.ClassName, @"Static");
                    fWindowsFirewallText.UIMap.SearchProperties.Add(UIASearchProperty.AutomationId, @"7170");
                    fWindowsFirewallText.UIMap.SearchProperties.Add(UIASearchProperty.Name, @"Windows Firewall Configuration");
                }

                return fWindowsFirewallText;
            }
        }
        ...
        /// Gets Reference to desktop
        /// </summary>
        public Image WindowsFirewallImage
        {
            get
            {
                if (null == fWindowsFirewallImage)
                {
                    fWindowsFirewallImage = new Image("WindowsFirewallImage", HPDigitalSendinWindow);
                    fWindowsFirewallImage.UIMap.Scope = UIASeachScope.Children;
                    fWindowsFirewallImage.UIMap.SearchProperties.Add(UIASearchProperty.ClassName, @"Static");
                    fWindowsFirewallImage.UIMap.SearchProperties.Add(UIASearchProperty.AutomationId, @"8422");
                    fWindowsFirewallImage.UIMap.SearchProperties.Add(UIASearchProperty.Name, @"Windows Firewall Configuration");
                }

                return fWindowsFirewallImage;
            }
        }

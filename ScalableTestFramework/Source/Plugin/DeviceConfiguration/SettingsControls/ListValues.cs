...
namespace HP.ScalableTest.Plugin.DeviceConfiguration.SettingsControls
{
    internal static class ListValues
    {
        ...
        #region Manage Trays
        public static Dictionary<string, string> UseRequesetedTray = new Dictionary<string, string> { { "Exclusively", "Exclusively" }, { "When Available", "WhenAvailable" } };

        public static Dictionary<string, string> ManualFeedPrompt = new Dictionary<string, string> { { "Always Prompt", "AlwaysPrompt" }, { "Prompt On Mismatch", "PromptOnMismatch" } };

        public static Dictionary<string, string> SizeTypePrompt = new Dictionary<string, string> { { "Display", "Display" }, { "Do not display", "DoNotDisplay" } };

        public static Dictionary<string, string> UseAnotherTray = new Dictionary<string, string> { { "Allow", "Allow" }, { "Do not allow", "DoNotAllow" } };

        public static Dictionary<string, string> AlternativeLetterheadMode = new Dictionary<string, string> { { "Off", "Off" }, { "On", "On" } };

        public static Dictionary<string, string> DuplexBlankPages = new Dictionary<string, string> { { "Automatic", "Automatic" }, { "Always", "Always" } };

        public static Dictionary<string, string> ImageRotation = new Dictionary<string, string> { { "Left to right", "LeftToRight" }, { "Right to left", "RightToLeft" }, { "Alternate", "Alternate" } };

        public static Dictionary<string, string> OverrideA4Letter = new Dictionary<string, string> { { "No", "No" }, { "Yes", "Yes" } };

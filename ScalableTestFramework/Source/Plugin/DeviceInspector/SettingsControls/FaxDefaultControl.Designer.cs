...
namespace HP.ScalableTest.Plugin.DeviceInspector.SettingsControls
{
    partial class FaxDefaultControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.faxNumber_choiceTextControl = new ChoiceTextControl();
            this.companyName_choiceTextControl = new ChoiceTextControl();
            this.location_choiceTextControl = new ChoiceTextControl();
            this.faxMethod_ComboBox = new ChoiceComboControl();
            this.fileFormat_ChoiceControl = new ChoiceComboControl();
            this.thirdParty_ChoiceControl = new ChoiceComboControl();
            this.scanSettingsUserControl = new ScanSettingsUserControl();
            this.resolution_choiceControl = new ChoiceComboControl();

...
namespace HP.ScalableTest.Plugin.DeviceInspector.SettingsControls
{
    public partial class GeneralSettingsControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ipAddress_Control = new ChoiceIPControl();
            this.timeZone_ComboBox = new ChoiceComboControl();
            this.time_TimePicker = new ChoiceTimePicker();
            this.date_TimePicker = new ChoiceTimePicker();
            this.syncTime_ComboBox = new ChoiceComboControl();
            this.sleepTimer_ComboBox = new ChoiceComboControl();
            this.activityTimeout_ComboBox = new ChoiceComboControl();
            this.port_TextBox = new ChoiceTextControl();

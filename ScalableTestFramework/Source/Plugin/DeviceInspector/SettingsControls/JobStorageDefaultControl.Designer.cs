...
namespace HP.ScalableTest.Plugin.DeviceInspector.SettingsControls
{
    partial class JobStorageDefaultControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.folderName_choiceTextControl = new ChoiceTextControl();
            this.enable_choiceComboControl = new ChoiceComboControl();
            this.retainJobs_choiceComboControl = new ChoiceComboControl();
            this.pinRequired_choiceComboControl = new ChoiceComboControl();
            this.pinLength_choiceComboControl = new ChoiceComboControl();
            this.SuspendLayout();
            // 
            // enable_label
            // 

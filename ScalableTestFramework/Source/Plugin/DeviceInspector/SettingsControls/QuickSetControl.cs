...
namespace HP.ScalableTest.Plugin.DeviceInspector.SettingsControls
{
    ...
    public partial class QuickSetControl : UserControl, IGetSetComponentData
    {
        ...
        public void SetFieldInfo()
        {
            ...
            resolution_ComboBox.SelectedItem = ListValues.Resolution.FirstOrDefault(x=>x.Value.Equals(_SelectedQuickSet.FileSetData.Resolution.Key));
        ...
        private void ChangeQuickSetType(object sender, EventArgs e)
        {
            ...
            switch (quickSetType_ComboBox.SelectedValue.ToString())
            {
                ...
                {
                    _currentType = "FTP";
                    _parameterList.Add(new QuickSetParameterData("FTP Server", "",
                        $@"FTP Server Path -- ftp.test.com"));
                    _parameterList.Add(new QuickSetParameterData("Port", "21", $@"Port number"));
                    _parameterList.Add(new QuickSetParameterData("Directory Path", "",
                ...
                switch (quickSetType_ComboBox.SelectedValue.ToString())
                {
                    ...
                    case "Folder":
                        ...
                        if (STNFQuickSetData.Validate(param))
                        {
                            ...
                            addQuickSet = new STNFQuickSetData(folderPath, name_TextBox.Text, _currentType, scanSettingsData, fileSettingsData);
                            _quickSetList.QuickSetData.Key.Add(addQuickSet);
                            _viewList.Add(new QuickSetTableData(addQuickSet.QName, addQuickSet.QType));
                            success = true;
                        }

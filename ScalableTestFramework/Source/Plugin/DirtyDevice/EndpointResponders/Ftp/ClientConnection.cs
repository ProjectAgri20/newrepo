...
namespace HP.ScalableTest.Plugin.DirtyDevice
{
    public class ClientConnection : IDisposable
    {
        ...
        public ClientConnection(FtpServer ftpServer, TcpClient client)
        {
        ...
        private FtpUser _ftpUser = new FtpUser();

...
namespace HP.ScalableTest.Plugin.EdtIntervention
{
    class FaultEventConstants
    {
        ...
        {   
            get { return EnumUtil.GetDescriptions<ERR_EVENT_TYPES>().ToList(); }
        }
        ...
        {
            get { return EnumUtil.GetDescriptions<ERR_SUBEVENTS>().ToList(); }
        }
        ...
        /// </summary>
        /// <returns>List of Strings</returns>
        public static List<String> JamTypes
        {
            get { return EnumUtil.GetDescriptions<JAM_SUBEVENTS>().ToList(); }
        }
        ...
        {
            get { return EnumUtil.GetDescriptions<FAULT_OP_IN_PROGS>().ToList(); }
        }
        ...
        /// </summary>
        /// <returns>List of Strings</returns>
        public static List<String> ErrorRecoveries
        {
            get { return EnumUtil.GetDescriptions<ERR_EVENT_RECOVERIES>().ToList(); }
        }
        ...
        /// </summary>
        /// <returns>List of Strings</returns>
        public static List<String> JamRecoveries
        {
            get { return EnumUtil.GetDescriptions<JAM_RECOVERIES>().ToList(); }
        }
        ...
        /// </summary>
        /// <returns>List of Strings</returns>
        public static List<String> JobDispositions
        {
            get { return EnumUtil.GetDescriptions<FAULT_JOB_DISPOSITIONS>().ToList(); }
        }
        ...
        /// </summary>
        /// <returns>List of Strings</returns>
        public static List<String> HangTypes
        {
            get { return EnumUtil.GetDescriptions<ERR_EVENT_HANGS>().ToList(); }
        }
        ...
        /// </summary>
        /// <returns>List of Strings</returns>
        public static List<String> RootCauses
        {
            get { return EnumUtil.GetDescriptions<FAULT_ROOT_CAUSES>().ToList(); }
        }

        public static Guid GetEventTypeId(string value)
        {
            return new Guid(Enum<ERR_EVENT_TYPES>.Value(EnumUtil.GetByDescription<ERR_EVENT_TYPES>(value)));
        }
        ...
        {
            return new Guid(Enum<FAULT_OP_IN_PROGS>.Value(EnumUtil.GetByDescription<FAULT_OP_IN_PROGS>(value)));
        }
        ...
        {
            return new Guid(Enum<FAULT_JOB_DISPOSITIONS>.Value(EnumUtil.GetByDescription<FAULT_JOB_DISPOSITIONS>(value)));
        }

        public static Guid GetRootCauseId(string value)
        {
            return new Guid(Enum<FAULT_ROOT_CAUSES>.Value(EnumUtil.GetByDescription<FAULT_ROOT_CAUSES>(value)));
        }
    }

    public enum ERR_EVENT_TYPES
    {
    ...
    public enum ERR_EVENT_RECOVERIES
    {   
    ...
    public enum FAULT_JOB_DISPOSITIONS
    {

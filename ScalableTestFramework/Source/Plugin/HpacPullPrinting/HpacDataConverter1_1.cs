...
{
    public class HpacDataConverter1_1 : PluginDataConverter, IPluginMetadataConverter
    {
        ...
        public XElement Convert(XElement xml)
        {
            ...
            HpacActivityData1_0 proxyData = Serializer.Deserialize<HpacActivityData1_0>(xml, Maps);
            ...
            HpacActivityData resultData = new HpacActivityData()
            {
                ...
                HpacAuthentication = UseSolutionAuth(rootNS, xml)
            };
        ...
        private void SetAction(PullPrintDocumentProcessActions oldAction, HpacActivityData newActivityData)
        {
            switch (oldAction)
            {
                case PullPrintDocumentProcessActions.PrintSingleDocument:
                    newActivityData.DocumentProcessAction = HpacPullPrintAction.PrintDelete;
                    break;
                case PullPrintDocumentProcessActions.PrintAllDocuments:
                    newActivityData.DocumentProcessAction = HpacPullPrintAction.PrintAll;
                    break;
                case PullPrintDocumentProcessActions.PrintKeepSingleDocument:
                    newActivityData.DocumentProcessAction = HpacPullPrintAction.PrintKeep;
                    break;
                ...
                case PullPrintDocumentProcessActions.DeleteSingleDocument:
                    newActivityData.DocumentProcessAction = HpacPullPrintAction.Delete;
                    break;
        ...
        private bool UseSolutionAuth(XNamespace rootNS, XElement xml)
        {
            ...
            return buttonElement != null ? (buttonElement.Value == "HP AC Secure Pull Print") : false;
        }
        ...
        private static IEnumerable<SerializerProxyMap> Maps
        {
            get
            {
                yield return new SerializerProxyMap(typeof(HpacActivityData1_0), "STF.Plugin.CommonWorkflowCandidates", "HP.DeviceAutomation.FeatureCandidate.PullPrinting", "PullPrintingActivityData");
    ...
    /// </summary>
    [DataContract]
    internal class HpacActivityData1_0
    {
        [DataMember]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HpacActivityData1_0"/> class.
        /// </summary>
        public HpacActivityData1_0()
        {

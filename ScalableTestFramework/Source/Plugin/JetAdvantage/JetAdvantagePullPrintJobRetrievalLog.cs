...
{
    public class JetAdvantagePullPrintJobRetrievalLog : ActivityDataLog
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JetAdvantagePullPrintJobRetrievalLog"/> class.
        /// </summary>
        public JetAdvantagePullPrintJobRetrievalLog(PluginExecutionData executionData)
            : base(executionData)
        {
            DeviceId = null;
        ...
        {
            get { return "JetAdvantagePullPrintJobRetrieval"; }
        }
    }
}

<tcx:Context xmlns:tcx="http://sherman.americas.hpqcorp.net/topcat/schemas/framework" xmlns:gui="http://sherman.americas.hpqcorp.net/topcat/schemas/tools/gui-automation">
  <tcx:Resources>
    ...
    <gui:TreeItem tcx:ID="HPUniversalPrinTreeItem">
      ...
      <gui:SearchProperties>
        <gui:SearchProperty gui:Name="Name">${DriverModel} Device Settings</gui:SearchProperty>
      </gui:SearchProperties>
    </gui:TreeItem>
    ...
    <gui:TreeItem tcx:ID="DuplexUnitfor2STreeItem">
      ...
      <gui:SearchProperties>
        <gui:SearchProperty gui:Name="Name">Duplex Unit (for 2-Sided Printing): Installed</gui:SearchProperty>
      </gui:SearchProperties>
    </gui:TreeItem>
    <gui:TreeItem tcx:ID="DuplexUnitfor2SNTreeItem">
      <gui:ReferenceContainer gui:Scope="Children">${Context}.InstallableOptiTreeItem</gui:ReferenceContainer>
      <gui:SearchProperties>
        <gui:SearchProperty gui:Name="Name">Duplex Unit (for 2-Sided Printing): Not Installed</gui:SearchProperty>
      </gui:SearchProperties>
    </gui:TreeItem>
    ...
    <gui:ListItem tcx:ID="Automatically SelectListItem">
      <gui:ProviderType>ManagedUIA</gui:ProviderType>
    ...
    <gui:ListItem tcx:ID="Printer auto selectListItem">
      <gui:ProviderType>ManagedUIA</gui:ProviderType>
      <gui:ReferenceContainer gui:Scope="Children">${Context}.PapersourceCombList</gui:ReferenceContainer>
      <gui:SearchProperties>

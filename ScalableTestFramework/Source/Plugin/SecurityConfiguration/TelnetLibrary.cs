...
namespace HP.ScalableTest.Plugin.SecurityConfiguration
{
    public class TelnetLibrary : IDisposable
    {
        ...
        {
            ProcessUtil.Execute("dism.exe", "/online /enable-feature /featurename:TelnetClient /NoRestart");
        ...
        {
            ProcessUtil.Execute("dism.exe", "/online /disable-feature /featurename:TelnetClient /NoRestart");
            Thread.Sleep(TimeSpan.FromMinutes(1));
        }

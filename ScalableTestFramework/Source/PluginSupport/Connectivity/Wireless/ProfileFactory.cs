...
namespace HP.ScalableTest.PluginSupport.Connectivity.Wireless
{
    ...
    /// <summary>
    /// Creates profile xml based on the type of the wireless network connection
    /// </summary>
	internal static class ProfileFactory
    {
        ...
        {
            string resourceName = string.Format("HP.ScalableTest.PluginSupport.Connectivity.Wireless.ProfileXML.{0}.xml", name);
